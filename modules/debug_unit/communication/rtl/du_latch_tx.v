...
//---------------------------------------- local params ------------------------------------------//
  ...
  localparam                                                    NB_BYTECNT    = $clog2(NB_BYTES + 1) ;
...
//------------------------------------------ Registers -------------------------------------------//
  ...
  reg  [NB_BYTECNT                                     - 1 : 0] byte_cnt_reg                     ;
  reg  [NB_BYTECNT                                     - 1 : 0] byte_cnt_next                    ;
...
//------------------------------------------ Packet wire ----------------------------------------//
  ...
  assign pkt_data[ 9*8 +: 8] = {{7{1'b0}}, i_idex_ctrl[8]}                                        ;
  ...
  assign pkt_data[22*8 +: 8] = {{3{1'b0}}, i_idex_rd_addr}                                        ;
  assign pkt_data[23*8 +: 8] = {{3{1'b0}}, i_idex_rs1_addr}                                       ;
  assign pkt_data[24*8 +: 8] = {{3{1'b0}}, i_idex_rs2_addr}                                       ;
  // EX/MEM   
  assign pkt_data[25*8 +: 8] = {{4{1'b0}}, i_exmem_ctrl}                                          ;
  ...
  assign pkt_data[34*8 +: 8] = {{3{1'b0}}, i_exmem_rd_addr}                                       ;
  // MEM/WB   
  assign pkt_data[35*8 +: 8] = {{6{1'b0}}, i_memwb_ctrl}                                          ;
  ...
  assign pkt_data[44*8 +: 8] = {{3{1'b0}}, i_memwb_rd_addr}                                       ;
