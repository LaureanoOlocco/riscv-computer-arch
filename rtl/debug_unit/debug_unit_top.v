...
#(
    ...
    // Outputs — Instruction memory write (du_imem_loader)
    ...
    // Outputs — Breakpoint hit
    output wire                         o_bkp_hit        ,  // Breakpoint hit signal

    // Outputs — UART TX (multiplexed)
    ...
    // =========================================================================
    // Output Multiplexing (OR-gating — only one submodule active at a time)
    // =========================================================================
